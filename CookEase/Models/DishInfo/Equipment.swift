...
struct EquipmentInfo: Codable {
    ...
    var id: Int = 0  // Refer to step - equipment - "id" in the json file.
...
struct TemperatureInfo: Codable {
    var number: Int? = nil     // Refer to step - equipment - temperature - "number"
    var unit: String? = nil    // Refer to step - equipment - temperature - "unit"
}
